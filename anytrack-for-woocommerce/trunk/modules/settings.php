...
class anytrack_for_woocommerce_SettingsClassV2
{
    ...
    public function create_menu($parameters)
    {
    ...
    public function show_settings()
    {
        ...
        if (count($this->setttings_parameters[0]['parameters']) == 0) {
            return false;
        } ?>
        ...
        foreach ($this->setttings_parameters as $single_page) {
            if (!isset($single_page['parameters'])) {
                continue;
            }
        ...
        array(
            ...
            'parameters' => array(
                ...
                array(
                    ...
                    'sub_text' =>  __('You can find your property id under <a href="https://dashboard.anytrack.io/asset/tracking-script" target="_blank">Property Settings</a>.', $locale),
                    'id' => '',
                    'class' => ''
                ),
