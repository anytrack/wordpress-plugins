<?php 
	...
	class anytrack_for_woocommerce_AddStylesSync{
		/* V1.0.1 */
...
add_Action('init', function(  ){
		...
		'admin' => array(
			...
			array( 'type' => 'script', 'url' => plugins_url('/inc/qtip/jquery.qtip.js', __FILE__ ), 'enq' => array( 'jquery' ) ),
			array( 'type' => 'script', 'url' => plugins_url('/inc/qtip/imagesloaded.pkg.min.js', __FILE__ ), 'enq' => array( 'jquery' ) ),
